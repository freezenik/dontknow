...
SEXP hess_mu1_dontknow(SEXP, SEXP, SEXP, SEXP);
SEXP hess_mu2_dontknow(SEXP, SEXP, SEXP, SEXP);
SEXP score_alpha_dontknow(SEXP, SEXP, SEXP, SEXP, SEXP, SEXP);
SEXP hess_alpha_dontknow(SEXP, SEXP, SEXP, SEXP, SEXP);
...
static R_CallMethodDef callMethods[] = {
  ...
  {"hess_mu1_dontknow",  (DL_FUNC) &hess_mu1_dontknow,  4},
  {"hess_mu2_dontknow",  (DL_FUNC) &hess_mu2_dontknow,  4},
  {"score_alpha_dontknow",(DL_FUNC) &score_alpha_dontknow,6},
  {"hess_alpha_dontknow", (DL_FUNC) &hess_alpha_dontknow, 5},
  {NULL, NULL, 0}
};
